...
set -gx VIRTUAL_ENV /home/unimelb.edu.au/pillaip/STI-Modelling-Project/devMay2026/partnersim-dynet/.venv
...
if test -n partnersim-dynet-py3.11
    set -gx VIRTUAL_ENV_PROMPT partnersim-dynet-py3.11
else

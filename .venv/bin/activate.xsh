...
class _VirtualEnvActivator:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.embedded_virtual_env = '/home/unimelb.edu.au/pillaip/STI-Modelling-Project/devMay2026/partnersim-dynet/.venv'
            self.embedded_virtual_prompt = 'partnersim-dynet-py3.11'

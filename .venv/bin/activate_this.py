...
os.environ["VIRTUAL_ENV_PROMPT"] = 'partnersim-dynet-py3.11' or os.path.basename(base)  # ty: ignore[unresolved-reference]
...
for lib in '../lib/python3.11/site-packages'.split(os.pathsep):  # ty: ignore[unresolved-reference]

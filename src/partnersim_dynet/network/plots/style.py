"""Shared style for network plots.

NOTE: The colors here are OVERWRITTEN by the `partnersim_dynet.network.plots.ego_network_new` module.

This script needs to be updated as plots are generated by the individual scripts.
...
class NetworkPalette:
    ...
    # Orientation colors — used in ego networks
